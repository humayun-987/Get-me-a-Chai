...
const Login = () => {
    ...
    return (
        <div className='text-white mt-10 pt-10 flex flex-col justify-center items-center container mx-auto'>
            <h2 className='text-3xl px-8 text-center font-bold '>Login to get your Fans to support you</h2>
            <div className="flex flex-col gap-2 min-h-screen bg-transparent p-10">
                <button
                    className="flex items-center border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-black bg-white hover:text-gray-900 hover:bg-gray-300 focus:outline-none  focus:ring-2  focus:ring-offset-2  focus:ring-gray-500">
                    <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xlmnsXlink="http://www.w3.org/1999/xlink"
